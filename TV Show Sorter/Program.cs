...
namespace TV_Show_Sorter
{
    class Program
    {
        ...
        public static string DestinationFolderConfig = ConfigurationManager.AppSettings["DestinationFolder"];
        ...
        private static void SetDestinationFolder()
        {
            ...
            {
                DestinationFolder = SearchFolder;
            }
            else if (EnableOutFolder == "true")
            {
                DestinationFolder = DestinationFolderConfig;
            }
        }
        ...
        {
            foreach (string file in Directory.GetFiles(SearchFolder, "*.*", SearchOption.AllDirectories))
            {
                ...
                if (tvShow.IsMatch(fileNoExt))
                {
                    ...
                    string showFolder = Path.Combine(DestinationFolder, showName);
